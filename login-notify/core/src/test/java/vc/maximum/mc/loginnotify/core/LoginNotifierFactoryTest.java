...
class LoginNotifierFactoryTest {
    ...
    void createsNoOpNotifierWhenTypeIsNoop() {
        LoginNotifySettings settings = new LoginNotifySettings("noop", DiscordNotifierSettings.defaults());
    ...
    void createsDiscordNotifierWhenWebhookIsConfigured() {
        LoginNotifySettings settings = new LoginNotifySettings(
                "discord",
                new DiscordNotifierSettings("https://discord.example/webhook", 5763719, 15548997, true, true, true));
    ...
    void fallsBackToNoOpWhenDiscordWebhookIsMissing() {
        LoginNotifySettings settings = new LoginNotifySettings("discord", DiscordNotifierSettings.defaults());
    ...
    void fallsBackToNoOpForUnknownType() {
        LoginNotifySettings settings = new LoginNotifySettings("slack", DiscordNotifierSettings.defaults());
    ...
    void discordFromSettingsReturnsNullWhenWebhookIsMissing() {
        assertNull(DiscordWebhookLoginNotifier.fromSettings(DiscordNotifierSettings.defaults(), LOGGER));
    }
}
